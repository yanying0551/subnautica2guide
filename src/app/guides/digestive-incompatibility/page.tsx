...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: pick("Digestive Incompatibility Guide — Under Source Review", "消化不相容指南——来源核验中", locale),
...
export default async function Page() {
  const locale = await getLocale();
  return <SourceReviewPage locale={locale} title={pick("Digestive Incompatibility Guide", "消化不相容指南", locale)} />;
}
