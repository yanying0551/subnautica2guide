...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: pick("Base Building Guide — Under Source Review", "基地建造指南——来源核验中", locale),
...
export default async function Page() {
  const locale = await getLocale();
  return <SourceReviewPage locale={locale} title={pick("Base Building Guide", "基地建造指南", locale)} />;
}
