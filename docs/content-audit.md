...
| 2026-08-21 | `/guides/beginner-guide`, `/resources/[slug]` | Reconciled sitemap and detail metadata with the under-review ledger. | Removed beginner guide from English/Chinese sitemap output; resource details now explicitly return `noindex, follow`. |
